      ...
      <div className="min-h-screen flex items-center justify-center bg-background overflow-hidden relative">
         ...
         <div className="text-center max-w-2xl px-4 relative z-10">
            ...
            <p className="mt-6 text-lg text-secondary-foreground ">
               Craft stunning, customizable themes for your shadcn UI projects
               with ease. Whether you're building a sleek dashboard or a vibrant
               portfolio, our generator empowers you to create themes that shine
